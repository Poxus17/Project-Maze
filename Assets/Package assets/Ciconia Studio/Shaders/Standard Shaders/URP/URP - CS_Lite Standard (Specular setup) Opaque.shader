Shader "Ciconia Studio/CS_Standard/URP/Lite/Standard (Specular setup)/Opaque"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN , half ase_vface : VFACE ) : SV_Target
			{
				...
				float2 break26_g492 = uv_BaseMap;
				...
				float2 paralaxOffset36_g488 = ParallaxOffset( temp_cast_0.x , _Parallax , ase_tanViewDir );
				float2 switchResult47_g488 = (((ase_vface>0)?(paralaxOffset36_g488):(0.0)));
				float2 Parallaxe375 = switchResult47_g488;
				float4 tex2DNode7_g491 = tex2D( _BaseMap, ( ( appendResult14_g492 + appendResult13_g492 ) + Parallaxe375 ) );
				float clampResult27_g491 = clamp( _Saturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g491 = ( _BaseColor * tex2DNode7_g491 ).rgb;
				...
				float4 tex2DNode7_g552 = tex2D( _DetailAlbedoMap, uv_DetailAlbedoMap );
				float clampResult27_g552 = clamp( _DetailSaturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g552 = ( _DetailColor * tex2DNode7_g552 ).rgb;
				...
				float4 AlbedoDetail153 = CalculateContrast(_DetailBrightness,float4( desaturateVar29_g552 , 0.0 ));
				float4 temp_cast_6 = (0.0).xxxx;
				float2 uv_DetailMask = IN.ase_texcoord7.xy * _DetailMask_ST.xy + _DetailMask_ST.zw;
				float4 tex2DNode27_g551 = tex2D( _DetailMask, uv_DetailMask );
				#if defined(_CHANNELSELECTIONMASK_RED)
				float staticSwitch28_g551 = tex2DNode27_g551.r;
				#elif defined(_CHANNELSELECTIONMASK_GREEN)
				float staticSwitch28_g551 = tex2DNode27_g551.g;
				#elif defined(_CHANNELSELECTIONMASK_BLUE)
				float staticSwitch28_g551 = tex2DNode27_g551.b;
				#elif defined(_CHANNELSELECTIONMASK_ALPHA)
				float staticSwitch28_g551 = tex2DNode27_g551.a;
				#else
				float staticSwitch28_g551 = tex2DNode27_g551.r;
				#endif
				float BaseColorAlpha46 = (( _InvertABaseColor1 )?( ( 1.0 - tex2DNode7_g491.a ) ):( tex2DNode7_g491.a ));
				float temp_output_43_0_g551 = BaseColorAlpha46;
				#if defined(_SOURCEMASK_DETAILMASK)
				float staticSwitch45_g551 = (( _InvertMask )?( ( 1.0 - staticSwitch28_g551 ) ):( staticSwitch28_g551 ));
				#elif defined(_SOURCEMASK_BASECOLORALPHA)
				float staticSwitch45_g551 = temp_output_43_0_g551;
				#elif defined(_SOURCEMASK_BOTH)
				float staticSwitch45_g551 = ( (( _InvertMask )?( ( 1.0 - staticSwitch28_g551 ) ):( staticSwitch28_g551 )) + temp_output_43_0_g551 );
				#else
				float staticSwitch45_g551 = (( _InvertMask )?( ( 1.0 - staticSwitch28_g551 ) ):( staticSwitch28_g551 ));
				#endif
				float4 temp_cast_7 = (staticSwitch45_g551).xxxx;
				float4 clampResult38_g551 = clamp( ( CalculateContrast(( _ContrastDetailMap + 1.0 ),temp_cast_7) + -_SpreadDetailMap ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 Mask158 = (( _EnableDetailMask )?( ( clampResult38_g551 * _IntensityMask ) ):( temp_cast_6 ));
				...
				float2 break26_g555 = uv_BumpMap;
				...
				float3 unpack4_g554 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult14_g555 + appendResult13_g555 ) + Parallaxe375 ) ), _BumpScale );
				unpack4_g554.z = lerp( 1, unpack4_g554.z, saturate(_BumpScale) );
				float3 temp_output_396_0 = unpack4_g554;
				float2 uv_DetailNormalMap = IN.ase_texcoord7.xy * _DetailNormalMap_ST.xy + _DetailNormalMap_ST.zw;
				float3 unpack4_g553 = UnpackNormalScale( tex2D( _DetailNormalMap, uv_DetailNormalMap ), _DetailNormalMapScale );
				unpack4_g553.z = lerp( 1, unpack4_g553.z, saturate(_DetailNormalMapScale) );
				float3 NormalDetail155 = unpack4_g553;
				float3 lerpResult137 = lerp( temp_output_396_0 , NormalDetail155 , Mask158.rgb);
				float3 lerpResult205 = lerp( temp_output_396_0 , BlendNormal( temp_output_396_0 , NormalDetail155 ) , Mask158.rgb);
				...
				float2 break26_g559 = uv_EmissionMap;
				...
				float4 Emission110 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g559 + appendResult13_g559 ) + Parallaxe375 ) ) * _EmissionIntensity );
				
				float2 uv_SpecGlossMap = IN.ase_texcoord7.xy * _SpecGlossMap_ST.xy + _SpecGlossMap_ST.zw;
				float2 break26_g561 = uv_SpecGlossMap;
				...
				float4 tex2DNode3_g560 = tex2D( _SpecGlossMap, ( ( appendResult14_g561 + appendResult13_g561 ) + Parallaxe375 ) );
				float4 Specular41 = ( _SpecularColor * tex2DNode3_g560 * _SpecularIntensity );
				
				#if defined(_SOURCE_SPECULARALPHA)
				float staticSwitch31_g560 = ( tex2DNode3_g560.a * _Smoothness );
				#elif defined(_SOURCE_BASECOLORALPHA)
				float staticSwitch31_g560 = ( _Smoothness * BaseColorAlpha46 );
				#else
				float staticSwitch31_g560 = ( tex2DNode3_g560.a * _Smoothness );
				#endif
				float DetailBaseColorAlpha170 = ( _DetailColor.a * tex2DNode7_g552.a );
				float lerpResult385 = lerp( staticSwitch31_g560 , DetailBaseColorAlpha170 , Mask158.r);
				float Smoothness40 = lerpResult385;
				
				float2 uv_OcclusionMap = IN.ase_texcoord7.xy * _OcclusionMap_ST.xy + _OcclusionMap_ST.zw;
				float2 break26_g557 = uv_OcclusionMap;
				float2 appendResult14_g557 = (float2(( break26_g557.x * GlobalTilingX11 ) , ( break26_g557.y * GlobalTilingY8 )));
				float2 appendResult13_g557 = (float2(( break26_g557.x + GlobalOffsetX10 ) , ( break26_g557.y + GlobalOffsetY9 )));
				float blendOpSrc2_g556 = tex2D( _OcclusionMap, ( ( appendResult14_g557 + appendResult13_g557 ) + Parallaxe375 ) ).r;
				float blendOpDest2_g556 = ( 1.0 - _OcclusionStrength );
				float AmbientOcclusion94 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc2_g556 ) * ( 1.0 - blendOpDest2_g556 ) ) ));
