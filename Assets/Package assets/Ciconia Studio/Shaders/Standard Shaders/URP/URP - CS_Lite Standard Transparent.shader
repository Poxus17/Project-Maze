Shader "Ciconia Studio/CS_Standard/URP/Lite/Standard/Transparent"
{
	Properties
	{
		...
		[Space(35)][Header(Mask Properties)][Toggle]_EnableDetailMask("Enable", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN , half ase_vface : VFACE ) : SV_Target
			{
				...
				float4 temp_cast_0 = (tex2D( _ParallaxMap, ( appendResult14_g515 + appendResult13_g515 ) ).g).xxxx;
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 ase_tanViewDir =  tanToWorld0 * WorldViewDirection.x + tanToWorld1 * WorldViewDirection.y  + tanToWorld2 * WorldViewDirection.z;
				ase_tanViewDir = normalize(ase_tanViewDir);
				float2 paralaxOffset36_g514 = ParallaxOffset( temp_cast_0.x , _Parallax , ase_tanViewDir );
				float2 switchResult47_g514 = (((ase_vface>0)?(paralaxOffset36_g514):(0.0)));
				float2 Parallaxe383 = switchResult47_g514;
				float4 tex2DNode7_g558 = tex2D( _BaseMap, ( ( appendResult14_g559 + appendResult13_g559 ) + Parallaxe383 ) );
				float clampResult27_g558 = clamp( _Saturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g558 = ( _Color * tex2DNode7_g558 ).rgb;
				...
				float4 temp_output_419_0 = CalculateContrast(_Brightness,float4( desaturateVar29_g558 , 0.0 ));
				float2 uv_DetailAlbedoMap = IN.ase_texcoord7.xy * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				float4 tex2DNode7_g561 = tex2D( _DetailAlbedoMap, uv_DetailAlbedoMap );
				float clampResult27_g561 = clamp( _DetailSaturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g561 = ( _DetailColor * tex2DNode7_g561 ).rgb;
				float desaturateDot29_g561 = dot( desaturateInitialColor29_g561, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar29_g561 = lerp( desaturateInitialColor29_g561, desaturateDot29_g561.xxx, -clampResult27_g561 );
				float4 AlbedoDetail153 = CalculateContrast(_DetailBrightness,float4( desaturateVar29_g561 , 0.0 ));
				float4 temp_cast_6 = (0.0).xxxx;
				float2 uv_DetailMask = IN.ase_texcoord7.xy * _DetailMask_ST.xy + _DetailMask_ST.zw;
				float4 tex2DNode27_g560 = tex2D( _DetailMask, uv_DetailMask );
				#if defined(_CHANNELSELECTIONMASK_RED)
				float staticSwitch28_g560 = tex2DNode27_g560.r;
				#elif defined(_CHANNELSELECTIONMASK_GREEN)
				float staticSwitch28_g560 = tex2DNode27_g560.g;
				#elif defined(_CHANNELSELECTIONMASK_BLUE)
				float staticSwitch28_g560 = tex2DNode27_g560.b;
				#elif defined(_CHANNELSELECTIONMASK_ALPHA)
				float staticSwitch28_g560 = tex2DNode27_g560.a;
				#else
				float staticSwitch28_g560 = tex2DNode27_g560.r;
				#endif
				float BaseColorAlpha46 = (( _InvertABaseColor )?( ( 1.0 - tex2DNode7_g558.a ) ):( tex2DNode7_g558.a ));
				float temp_output_43_0_g560 = BaseColorAlpha46;
				#if defined(_SOURCEMASK_DETAILMASK)
				float staticSwitch45_g560 = (( _InvertMask )?( ( 1.0 - staticSwitch28_g560 ) ):( staticSwitch28_g560 ));
				#elif defined(_SOURCEMASK_BASECOLORALPHA)
				float staticSwitch45_g560 = temp_output_43_0_g560;
				#elif defined(_SOURCEMASK_BOTH)
				float staticSwitch45_g560 = ( (( _InvertMask )?( ( 1.0 - staticSwitch28_g560 ) ):( staticSwitch28_g560 )) + temp_output_43_0_g560 );
				#else
				float staticSwitch45_g560 = (( _InvertMask )?( ( 1.0 - staticSwitch28_g560 ) ):( staticSwitch28_g560 ));
				#endif
				float4 temp_cast_7 = (staticSwitch45_g560).xxxx;
				float4 clampResult38_g560 = clamp( ( CalculateContrast(( _ContrastDetailMap + 1.0 ),temp_cast_7) + -_SpreadDetailMap ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 Mask158 = (( _EnableDetailMask )?( ( clampResult38_g560 * _IntensityMask ) ):( temp_cast_6 ));
				float4 lerpResult365 = lerp( temp_output_419_0 , AlbedoDetail153 , Mask158);
				float4 blendOpSrc364 = temp_output_419_0;
				...
				float2 break26_g569 = uv_BumpMap;
				float2 appendResult14_g569 = (float2(( break26_g569.x * GlobalTilingX11 ) , ( break26_g569.y * GlobalTilingY8 )));
				float2 appendResult13_g569 = (float2(( break26_g569.x + GlobalOffsetX10 ) , ( break26_g569.y + GlobalOffsetY9 )));
				float3 unpack4_g568 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult14_g569 + appendResult13_g569 ) + Parallaxe383 ) ), _BumpScale );
				unpack4_g568.z = lerp( 1, unpack4_g568.z, saturate(_BumpScale) );
				float3 temp_output_414_0 = unpack4_g568;
				float2 uv_DetailNormalMap = IN.ase_texcoord7.xy * _DetailNormalMap_ST.xy + _DetailNormalMap_ST.zw;
				float3 unpack4_g563 = UnpackNormalScale( tex2D( _DetailNormalMap, uv_DetailNormalMap ), _DetailNormalMapScale );
				unpack4_g563.z = lerp( 1, unpack4_g563.z, saturate(_DetailNormalMapScale) );
				float3 NormalDetail155 = unpack4_g563;
				float3 lerpResult137 = lerp( temp_output_414_0 , NormalDetail155 , Mask158.rgb);
				float3 lerpResult205 = lerp( temp_output_414_0 , BlendNormal( temp_output_414_0 , NormalDetail155 ) , Mask158.rgb);
				...
				float2 break26_g571 = uv_EmissionMap;
				float2 appendResult14_g571 = (float2(( break26_g571.x * GlobalTilingX11 ) , ( break26_g571.y * GlobalTilingY8 )));
				float2 appendResult13_g571 = (float2(( break26_g571.x + GlobalOffsetX10 ) , ( break26_g571.y + GlobalOffsetY9 )));
				float4 Emission110 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g571 + appendResult13_g571 ) + Parallaxe383 ) ) * _EmissionIntensity );
				
				float2 uv_MetallicGlossMap = IN.ase_texcoord7.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float2 break26_g567 = uv_MetallicGlossMap;
				...
				float4 tex2DNode3_g566 = tex2D( _MetallicGlossMap, ( ( appendResult14_g567 + appendResult13_g567 ) + Parallaxe383 ) );
				float Metallic41 = ( tex2DNode3_g566.r * _Metallic );
				
				#if defined(_SOURCE_METALLICALPHA)
				float staticSwitch23_g566 = ( tex2DNode3_g566.a * _Smoothness );
				#elif defined(_SOURCE_BASECOLORALPHA)
				float staticSwitch23_g566 = ( _Smoothness * BaseColorAlpha46 );
				#else
				float staticSwitch23_g566 = ( tex2DNode3_g566.a * _Smoothness );
				#endif
				float DetailBaseColorAlpha170 = ( _DetailColor.a * tex2DNode7_g561.a );
				float lerpResult388 = lerp( staticSwitch23_g566 , DetailBaseColorAlpha170 , Mask158.r);
				float Smoothness40 = lerpResult388;
				...
				float blendOpSrc2_g564 = tex2D( _OcclusionMap, ( ( appendResult14_g565 + appendResult13_g565 ) + Parallaxe383 ) ).r;
				float blendOpDest2_g564 = ( 1.0 - _OcclusionStrength );
				...
				float4 tex2DNode8_g562 = tex2D( _TransparentMask, uv_TransparentMask );
				#if defined(_CHANNELSELECTION_RED)
				float staticSwitch30_g562 = tex2DNode8_g562.r;
				#elif defined(_CHANNELSELECTION_GREEN)
				float staticSwitch30_g562 = tex2DNode8_g562.g;
				#elif defined(_CHANNELSELECTION_BLUE)
				float staticSwitch30_g562 = tex2DNode8_g562.b;
				#elif defined(_CHANNELSELECTION_ALPHA)
				float staticSwitch30_g562 = tex2DNode8_g562.a;
				#else
				float staticSwitch30_g562 = tex2DNode8_g562.r;
				#endif
				float4 temp_cast_14 = ((( _InvertTransparent )?( ( 1.0 - (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g562 )) ) ):( (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g562 )) ))).xxxx;
				float4 clampResult24_g562 = clamp( ( CalculateContrast(( _ContrastTransparentMap + 1.0 ),temp_cast_14) + -_SpreadTransparentMap ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float4 Transparent375 = ( clampResult24_g562 * ( 1.0 - _IntensityTransparentMap ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , half ase_vface : VFACE ) : SV_TARGET
			{
				...
				float4 tex2DNode7_g558 = tex2D( _BaseMap, ( ( appendResult14_g559 + appendResult13_g559 ) + Parallaxe383 ) );
				float BaseColorAlpha46 = (( _InvertABaseColor )?( ( 1.0 - tex2DNode7_g558.a ) ):( tex2DNode7_g558.a ));
				float4 temp_cast_2 = ((( _InvertTransparent )?( ( 1.0 - (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g562 )) ) ):( (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g562 )) ))).xxxx;
				float4 clampResult24_g562 = clamp( ( CalculateContrast(( _ContrastTransparentMap + 1.0 ),temp_cast_2) + -_SpreadTransparentMap ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float4 Transparent375 = ( clampResult24_g562 * ( 1.0 - _IntensityTransparentMap ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , half ase_vface : VFACE ) : SV_TARGET
			{
				...
				float staticSwitch30_g562 = tex2DNode8_g562.r;
				#endif
				float4 temp_cast_11 = ((( _InvertTransparent )?( ( 1.0 - (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g562 )) ) ):( (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g562 )) ))).xxxx;
				float4 clampResult24_g562 = clamp( ( CalculateContrast(( _ContrastTransparentMap + 1.0 ),temp_cast_11) + -_SpreadTransparentMap ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float4 Transparent375 = ( clampResult24_g562 * ( 1.0 - _IntensityTransparentMap ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , half ase_vface : VFACE ) : SV_TARGET
			{
				...
				float staticSwitch30_g562 = tex2DNode8_g562.r;
				#endif
				float4 temp_cast_10 = ((( _InvertTransparent )?( ( 1.0 - (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g562 )) ) ):( (( _UseBaseColorAlpha )?( BaseColorAlpha46 ):( staticSwitch30_g562 )) ))).xxxx;
				float4 clampResult24_g562 = clamp( ( CalculateContrast(( _ContrastTransparentMap + 1.0 ),temp_cast_10) + -_SpreadTransparentMap ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float4 Transparent375 = ( clampResult24_g562 * ( 1.0 - _IntensityTransparentMap ) );
