	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN , half ase_vface : VFACE ) : SV_Target
			{
				...
				float2 break26_g616 = uv_BaseMap;
				...
				float4 tex2DNode7_g615 = tex2D( _BaseMap, ( ( appendResult14_g616 + appendResult13_g616 ) + Parallaxe359 ) );
				float clampResult27_g615 = clamp( _Saturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g615 = ( _BaseColor * tex2DNode7_g615 ).rgb;
				...
				float2 texCoord393 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				...
				#elif defined(_CHANNELSELECTIONMASK1_GREEN)
				float staticSwitch427 = triplanar399.y;
				#elif defined(_CHANNELSELECTIONMASK1_BLUE)
				float staticSwitch427 = triplanar399.z;
				#elif defined(_CHANNELSELECTIONMASK1_ALPHA)
				float staticSwitch427 = triplanar399.w;
				#else
				float staticSwitch427 = triplanar399.x;
				#endif
				float4 temp_cast_12 = ((( _InvertMask )?( ( 1.0 - (( _EnableTriplanarProjection )?( staticSwitch427 ):( staticSwitch428 )) ) ):( (( _EnableTriplanarProjection )?( staticSwitch427 ):( staticSwitch428 )) ))).xxxx;
				float4 clampResult413 = clamp( ( CalculateContrast(( _ContrastDetailMap + 1.0 ),temp_cast_12) + -_SpreadDetailMap ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				...
				float4 blendOpSrc15_g630 = temp_output_372_0;
				float4 blendOpDest15_g630 = lerpResult343;
				float4 lerpBlendMode15_g630 = lerp(blendOpDest15_g630,(( blendOpDest15_g630 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest15_g630 ) * ( 1.0 - blendOpSrc15_g630 ) ) : ( 2.0 * blendOpDest15_g630 * blendOpSrc15_g630 ) ),Mask158.x);
				#if defined(_BLENDMODE_NONE)
				float4 staticSwitch22_g630 = lerpResult343;
				#elif defined(_BLENDMODE_OVERLAY)
				float4 staticSwitch22_g630 = ( saturate( lerpBlendMode15_g630 ));
				#else
				float4 staticSwitch22_g630 = lerpResult343;
				#endif
				float4 Albedo26 = (( _VisualizeMask )?( Mask158 ):( staticSwitch22_g630 ));
				...
				float2 break26_g668 = uv_BumpMap;
				...
				float3 unpack4_g667 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult14_g668 + appendResult13_g668 ) + Parallaxe359 ) ), _BumpScale );
				unpack4_g667.z = lerp( 1, unpack4_g667.z, saturate(_BumpScale) );
				float3 temp_output_417_0 = unpack4_g667;
				...
				float3 lerpResult137 = lerp( temp_output_417_0 , NormalDetail155 , Mask158.rgb);
				float3 lerpResult205 = lerp( temp_output_417_0 , BlendNormal( temp_output_417_0 , NormalDetail155 ) , Mask158.rgb);
				...
				float2 break26_g660 = uv_EmissionMap;
				...
				float4 temp_output_426_0 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g660 + appendResult13_g660 ) + Parallaxe359 ) ) * _EmissionIntensity );
				...
				float BaseColorAlpha46 = (( _InvertABaseColor1 )?( ( 1.0 - tex2DNode7_g615.a ) ):( tex2DNode7_g615.a ));
				#if defined(_SOURCE_SPECULARALPHA)
				float staticSwitch31_g665 = ( tex2DNode3_g665.a * _Smoothness );
				#elif defined(_SOURCE_BASECOLORALPHA)
				float staticSwitch31_g665 = ( _Smoothness * BaseColorAlpha46 );
				#else
				float staticSwitch31_g665 = ( tex2DNode3_g665.a * _Smoothness );
				#endif
				...
				float2 break26_g662 = uv_OcclusionMap;
				float2 appendResult14_g662 = (float2(( break26_g662.x * GlobalTilingX11 ) , ( break26_g662.y * GlobalTilingY8 )));
				float2 appendResult13_g662 = (float2(( break26_g662.x + GlobalOffsetX10 ) , ( break26_g662.y + GlobalOffsetY9 )));
				float blendOpSrc2_g661 = tex2D( _OcclusionMap, ( ( appendResult14_g662 + appendResult13_g662 ) + Parallaxe359 ) ).r;
				float blendOpDest2_g661 = ( 1.0 - _OcclusionStrength );
				float temp_output_425_0 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc2_g661 ) * ( 1.0 - blendOpDest2_g661 ) ) ));
